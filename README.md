...
Mathematical functions—no matter how elegant, continuous, or infinitely precise—cannot represent physical reality at every point.
The material world is not structured by continuous formulas, but by algorithms.
Electron energy levels are quantized. Atoms are quantized.
...
- Planck’s minimum length

- And my personal idea that “God is a programmer”
...
What happens below that minimal size?
The same thing that happens when you use a floating-point index to access an integer array: you get one value or the other by approximation.
I don’t imagine the universe throwing an exception.
...
My answer: dedicated voxels, like RGB channels.
...
Consider an asymptotic function like 1/x.
Approaching from negative x toward zero, you can never cross x = 0 without “jumping.”
Movement in a continuous set requires teleporting from one point to another.
...
a universe made of voxels, quantized in every sense, governed by discrete algorithms rather than continuous mathematics.
